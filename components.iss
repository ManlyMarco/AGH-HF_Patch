...
Name: "BepInEx\ConfigurationManager";          Description: "Configuration Manager v18.0.1 (Can change plugin settings. Press F1 to open)"         ; Types: full_en extra_en full extra custom bare
...
Name: "Feature\VR";                            Description: "AGHVR v0.1 (VR mode for Houkago Rinkan Chuudoku)"                                     ; Types: extra extra_en
; -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Source: "Input\_Plugins\_out\AGHVR-BepInEx\*";              DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Components: Feature\VR; Excludes: "manifest.xml"
